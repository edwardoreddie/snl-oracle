  ...
  "pretape": {
    ...
    subQuestion: {
      ...
      options: [
        ...
        { label: "Schiller's Reel and TV Funhouse", sub: "The Ambiguously Gay Duo. Fun with Real Audio. Schiller's Reel.", weight: { 11: 1, 12: 1, 13: 1, 14: 2, 15: 2, 16: 2, 17: 2, 18: 2, 19: 2, 20: 2, 21: 3, 22: 3, 23: 3, 24: 3, 25: 3, 26: 3, 27: 2, 28: 2, 29: 2, 30: 2, 31: 2, 32: 1, 33: 1 } },
        ...
        { label: "Pre-tapes made in an apartment", sub: "Pete and Sandler's Stuck in the House. Everything shot from home in 2020.", weight: { 45: 4, 46: 3 } },
  ...
  "ten-to-one": {
    ...
    subQuestion: {
      ...
      options: [
        ...
        { label: "Kyle Mooney's last-slot pieces", sub: "Bruce Chandling. The bits that only aired at 12:55.", weight: { 39: 3, 40: 3, 41: 3, 42: 3, 43: 3, 44: 3, 45: 3, 46: 3, 47: 3 } },
  ...
  "topical": {
    ...
    subQuestion: {
      ...
      options: [
        ...
        { label: "Hartman's Reagan", sub: "The Mastermind. Warm on camera, ruthless off it.", weight: { 12: 3, 13: 3, 14: 2 } },
        { label: "Quaid and Sweeney as the Reagans", sub: "The wilderness year's Ron and Nancy.", weight: { 11: 3 } },
        { label: "Carvey's Bush 41", sub: "'Nah gonna do it.' 'Wouldn't be prudent.'", weight: { 14: 2, 15: 3, 16: 2, 17: 2, 18: 2 } },
        ...
        { label: "Bush 43 after Ferrell", sub: "Parnell. Forte. Sudeikis.", weight: { 28: 2, 29: 2, 30: 3, 31: 3, 32: 2, 33: 2 } },
        { label: "The Obama years", sub: "Armisen's Obama. Poehler's Hillary. Then Pharoah takes it over.", weight: { 33: 3, 34: 2, 35: 3, 36: 3, 37: 3, 38: 3, 39: 3, 40: 2, 41: 2 } },
  ...
  "loose": {
    ...
    subQuestion: {
      ...
      options: [
        ...
        { label: "The host losing it first", sub: "The guest breaking and taking the sketch down with them.", weight: { 15: 2, 16: 2, 17: 2, 18: 3, 19: 2, 24: 2, 25: 2, 26: 2, 27: 2 } },
        ...
        { label: "Nobody even pretending to hold it", sub: "The modern cast losing it every other week.", weight: { 29: 2, 30: 2, 39: 2, 41: 2, 42: 2, 43: 2, 44: 2, 45: 2, 46: 2, 49: 2, 50: 2, 51: 2 } },
  ...
  "commercial": {
    ...
    subQuestion: {
      ...
      options: [
        ...
        { label: "Modern pharma and app ads", sub: "Zillow. Levi's Wokes. Xanax for gay summer weddings.", weight: { 42: 2, 43: 2, 44: 2, 45: 2, 46: 2, 47: 3, 48: 2, 49: 2, 50: 2, 51: 2 } },
      ],
    },
  },
};
...
export const MOMENT_OPTIONS = [
  ...
  { label: "The Blues Brothers' first performance", weight: { 3: 4 } },
  ...
  { label: "Prince's first SNL performance", weight: { 6: 4 } },
  { label: "Eddie's last show as a cast member", weight: { 9: 4 } },
  ...
  { label: "Church Lady at her peak", weight: { 13: 4 } },
  ...
  { label: "It's Pat", weight: { 16: 4 } },
  { label: "Coffee Talk", weight: { 17: 3, 18: 2 } },
  { label: "Matt Foley van down by the river", weight: { 18: 4 } },
  { label: "Canteen Boy with Alec Baldwin", weight: { 19: 4 } },
  { label: "Norm's O.J. jokes at the desk", weight: { 20: 3, 21: 3, 22: 2 } },
  ...
  { label: "Mayor Giuliani opens the show", weight: { 27: 4 } },
  { label: "Mom Jeans", weight: { 28: 4 } },
  { label: "Debbie Downer", weight: { 29: 4 } },
  { label: "Tina and Amy take the desk", weight: { 30: 4 } },
  ...
  { label: "Pete Davidson and Dan Crenshaw", weight: { 44: 4 } },
  { label: "Sara Lee's social media guy", weight: { 45: 4 } },
  { label: "Bowen Yang as the Iceberg", weight: { 46: 4 } },
  { label: "Please Don't Destroy: Hard Seltzer", weight: { 47: 4 } },
  { label: "Lisa from Temecula", weight: { 48: 4 } },
  { label: "Bargatze's Washington Crosses the Delaware", weight: { 49: 4 } },
  { label: "Domingo", weight: { 50: 4 } },
...
export const ADAPTIVE_POOL = [
  {
    ...
    options: [
      ...
      { label: "Kevin Nealon", weight: { 17: 3, 18: 3, 19: 3 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "A cast built around one star", sub: "One person is clearly carrying it, and that's the appeal", weight: { 6: 2, 7: 3, 8: 3, 9: 3, 10: 2, 16: 2, 17: 2, 18: 3, 19: 2 } },
      { label: "A show in the middle of changing", sub: "New faces, a new desk, nobody sure what it is yet", weight: { 12: 2, 13: 2, 21: 2, 26: 2, 28: 2, 29: 2, 30: 2, 35: 2, 45: 2, 51: 2 } },
    ],
  },
  {
    id: "host-era",
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Catchphrase characters & broad bits", sub: "Roxbury Guys. Mary Katherine. Coffee Talk.", weight: { 13: 2, 14: 2, 15: 2, 17: 2, 18: 2, 21: 2, 22: 3, 23: 3, 24: 2, 25: 2, 30: 2, 37: 2, 38: 1 } },
      ...
      { label: "Anything from the original-cast era", sub: "If it looks like the 70s or early 80s, you skip it.", weight: { 1: 3, 2: 3, 3: 3, 4: 3, 5: 2, 6: 2, 7: 2, 8: 2, 9: 2, 10: 2, 11: 2, 12: 1 } },
    ],
  },
];
...
/* ============================================================
   ...
   `date` is the air date where it has been confirmed, as YYYY-MM-DD, or
   YYYY-MM / YYYY where only the month or year is settled. Entries without
   one are confident about the season but not yet about the date; they are
   not guesses to be trusted, they are gaps to be filled.
...
export const SKETCHES = [
  ...
  // --- Step 7 coverage pass. Every season to at least two, S40 on to four. ---
  { season: 2, title: "Baba Wawa at the desk", tier: "iconic", aspects: ["update", "impressions"] },
  { season: 2, title: "Chevy's last Weekend Update", tier: "deep_cut", aspects: ["update", "loose"] },
  { season: 4, title: "The Nerds: Todd and Lisa", tier: "iconic", date: "1979-01", aspects: ["recurring"] },
  { season: 5, title: "Roseanne Roseannadanna", tier: "iconic", aspects: ["update", "recurring"] },
  { season: 6, title: "Prince performs Partyup", tier: "iconic", date: "1981-02-21", aspects: ["music"] },
  { season: 6, title: "Charles Rocket at the Update desk", tier: "deep_cut", aspects: ["update", "loose"] },
  { season: 9, title: "Eddie's last show as a cast member", tier: "iconic", date: "1984-02-25", aspects: ["recurring", "loose"] },
  { season: 9, title: "Fernando's Hideaway", tier: "deep_cut", date: "1984", aspects: ["recurring", "host", "impressions"] },
  { season: 11, title: "Master Thespian debut", tier: "iconic", aspects: ["recurring"] },
  { season: 11, title: "Tommy Flanagan, Pathological Liar", tier: "iconic", aspects: ["recurring"] },
  { season: 19, title: "Canteen Boy with Alec Baldwin", tier: "iconic", date: "1994-02-19", aspects: ["recurring", "host"] },
  { season: 24, title: "The Ladies Man debut", tier: "iconic", aspects: ["recurring"] },
  { season: 28, title: "Mom Jeans", tier: "iconic", date: "2003-05-10", aspects: ["commercial", "pretape"] },
  { season: 28, title: "The Falconer debut", tier: "deep_cut", date: "2002-11-09", aspects: ["ten-to-one", "recurring"] },
  { season: 30, title: "Bush v. Kerry debate cold opens", tier: "iconic", aspects: ["cold-open", "topical"] },
  { season: 33, title: "Annuale", tier: "iconic", date: "2008-02-23", aspects: ["commercial", "pretape"] },
  { season: 38, title: "Djesus Uncrossed", tier: "iconic", date: "2013-02-16", aspects: ["pretape", "host"] },
  { season: 40, title: "SNL 40th Anniversary Special", tier: "iconic", date: "2015-02-15", aspects: ["host"] },
  { season: 40, title: "Back Home Ballers", tier: "iconic", date: "2014-11-22", aspects: ["pretape", "commercial"] },
  { season: 42, title: "Totino's with Kristen Stewart", tier: "iconic", date: "2017-02-04", aspects: ["commercial", "recurring"] },
  { season: 41, title: "Black Jeopardy with Drake", tier: "iconic", date: "2016-03", aspects: ["recurring", "topical", "host"] },
  { season: 41, title: "Meet Your Second Wife", tier: "deep_cut", date: "2015-12-19", aspects: ["host", "recurring"] },
  { season: 43, title: "Papyrus", tier: "iconic", date: "2017-10-14", aspects: ["pretape", "host"] },
  { season: 43, title: "Kellyanne Conway as Pennywise", tier: "deep_cut", date: "2017-10-07", aspects: ["topical", "recurring"] },
  { season: 44, title: "Pete Davidson and Dan Crenshaw", tier: "iconic", date: "2018-11-10", aspects: ["update", "topical"] },
  { season: 44, title: "Bodega Bathroom", tier: "iconic", date: "2019-03-02", aspects: ["host", "recurring"] },
  { season: 44, title: "Adam Sandler's tribute to Chris Farley", tier: "iconic", date: "2019-05-04", aspects: ["host", "music"] },
  { season: 45, title: "Stuck in the House", tier: "iconic", date: "2020-04-11", aspects: ["pretape", "music"] },
  { season: 45, title: "The Grouch", tier: "deep_cut", date: "2019-09-28", aspects: ["pretape", "host"] },
  { season: 46, title: "Dionne Warwick Talk Show", tier: "iconic", aspects: ["recurring", "impressions"] },
  { season: 46, title: "Chad on Mars with Elon Musk", tier: "deep_cut", date: "2021-05-08", aspects: ["recurring", "host"] },
  { season: 47, title: "Close Encounter, McKinnon's farewell", tier: "iconic", date: "2022-05-21", aspects: ["recurring", "loose"] },
  { season: 48, title: "Mario Kart with Pedro Pascal", tier: "iconic", date: "2023-02-04", aspects: ["pretape", "host"] },
  { season: 49, title: "Washington's Dream", tier: "iconic", date: "2023-10-28", aspects: ["host", "topical"] },
  { season: 49, title: "Beavis and Butt-Head", tier: "iconic", date: "2024-04-13", aspects: ["recurring", "host", "loose"] },
  { season: 50, title: "Ariana Grande's impressions monologue", tier: "iconic", aspects: ["host", "impressions", "music"] },
  { season: 51, title: "Will Ferrell hosts the finale", tier: "iconic", aspects: ["host"] },
];
