...
export const SKETCHES = [
  ...
  { season: 4, title: "The Nerds: Todd and Lisa", tier: "iconic", aspects: ["recurring"] },
  { season: 5, title: "Roseanne Roseannadanna", tier: "iconic", aspects: ["update", "recurring"] },
  { season: 6, title: "Prince performs Partyup", tier: "iconic", aspects: ["music"] },
  { season: 6, title: "Charles Rocket at the Update desk", tier: "deep_cut", aspects: ["update", "loose"] },
  { season: 9, title: "Eddie's last show as a cast member", tier: "iconic", aspects: ["recurring", "loose"] },
  { season: 9, title: "Fernando's Hideaway", tier: "deep_cut", aspects: ["recurring", "host", "impressions"] },
  ...
  { season: 19, title: "Canteen Boy with Alec Baldwin", tier: "iconic", aspects: ["recurring", "host"] },
  { season: 24, title: "The Ladies Man debut", tier: "iconic", aspects: ["recurring"] },
  { season: 28, title: "Mom Jeans", tier: "iconic", aspects: ["commercial", "pretape"] },
  { season: 28, title: "The Falconer debut", tier: "deep_cut", aspects: ["ten-to-one", "recurring"] },
  { season: 30, title: "Bush v. Kerry debate cold opens", tier: "iconic", aspects: ["cold-open", "topical"] },
  { season: 33, title: "Annuale", tier: "iconic", aspects: ["commercial", "pretape"] },
  { season: 38, title: "Djesus Uncrossed", tier: "iconic", aspects: ["pretape", "host"] },
  { season: 40, title: "SNL 40th Anniversary Special", tier: "iconic", aspects: ["host"] },
  { season: 40, title: "Back Home Ballers", tier: "iconic", aspects: ["pretape", "commercial"] },
  { season: 42, title: "Totino's with Kristen Stewart", tier: "iconic", aspects: ["commercial", "recurring"] },
  { season: 41, title: "Black Jeopardy with Drake", tier: "iconic", aspects: ["recurring", "topical", "host"] },
  { season: 41, title: "Meet Your Second Wife", tier: "deep_cut", aspects: ["host", "recurring"] },
  { season: 43, title: "Papyrus", tier: "iconic", aspects: ["pretape", "host"] },
  { season: 43, title: "Kellyanne Conway as Pennywise", tier: "deep_cut", aspects: ["topical", "recurring"] },
  { season: 44, title: "Pete Davidson and Dan Crenshaw", tier: "iconic", aspects: ["update", "topical"] },
  { season: 44, title: "Bodega Bathroom", tier: "iconic", aspects: ["host", "recurring"] },
  { season: 44, title: "Adam Sandler's tribute to Chris Farley", tier: "iconic", aspects: ["host", "music"] },
  { season: 45, title: "Stuck in the House", tier: "iconic", aspects: ["pretape", "music"] },
  { season: 45, title: "The Grouch", tier: "deep_cut", aspects: ["pretape", "host"] },
  { season: 46, title: "Dionne Warwick Talk Show", tier: "iconic", aspects: ["recurring", "impressions"] },
  { season: 46, title: "Chad on Mars with Elon Musk", tier: "deep_cut", aspects: ["recurring", "host"] },
  { season: 47, title: "Close Encounter, McKinnon's farewell", tier: "iconic", aspects: ["recurring", "loose"] },
  { season: 48, title: "Mario Kart with Pedro Pascal", tier: "iconic", aspects: ["pretape", "host"] },
  { season: 49, title: "Washington's Dream", tier: "iconic", aspects: ["host", "topical"] },
  { season: 49, title: "Beavis and Butt-Head", tier: "iconic", aspects: ["recurring", "host", "loose"] },
